...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.speakers'
        db.delete_column(u'mezzanine_events_event', 'speakers')


    def backwards(self, orm):
        # Adding field 'Event.speakers'
        db.add_column(u'mezzanine_events_event', 'speakers',
    ...
    models = {
        ...
        u'mezzanine_events.event': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'Event', '_ormbases': [u'pages.Page']},
        ...
        u'mezzanine_events.eventcontainer': {
            'Meta': {'ordering': "('_order',)", 'object_name': 'EventContainer', '_ormbases': [u'pages.Page']},
